...
<head>
    ...
    <style>
        ...
        .resumen h3 { font-size: 10px; font-weight: 900; color: #0b0f1a; margin: 0 0 8px 0; text-transform: uppercase; letter-spacing: 0.5px; }
    </style>
</head>
<body>
    @if (!($esPdf ?? false))
    ...
    <div class="header">
        ...
        <div class="periodo">Reporte Anual {{ $anio }}</div>
    </div>
    ...
    @foreach ($cierres as $c)
    @php $m = $dataPorMes[$c->mes] ?? null; @endphp
    @if ($m)
